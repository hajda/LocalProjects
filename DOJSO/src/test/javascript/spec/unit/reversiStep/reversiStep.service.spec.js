(function djsReversiStepServiceSpecsDefinition() {
    'use strict';

    describe('ReversiStep service >', function reversiStepServiceDescription() {
        ...
        beforeEach(inject(function injectDependencies(_DjsReversiStep_) {
        ...
        it('should ...', function spec() {
            ...
            var itemName = 'Item 0';
            // e.g. reversiStep.setItemName(myData, 0, itemName);
