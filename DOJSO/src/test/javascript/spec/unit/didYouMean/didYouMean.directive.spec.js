(function djsDidYouMeanDirectiveSpecsDefinition() {
    'use strict';

    describe('didYouMean directive >', function didYouMeanDirectiveDescription() {

        var directiveSnippet = '<djs-did-you-mean></djs-did-you-mean>', // TODO complete snippet with attributes/ template parameters / etc...
            $compile, $scope,
            DidYouMean
        ;
        ...
        beforeEach(inject(function injectDependencies(_$compile_, $rootScope, _DidYouMean_) {
            $compile = _$compile_
            $scope = $rootScope.$new();
